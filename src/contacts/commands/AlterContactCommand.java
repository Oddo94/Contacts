...
public class AlterContactCommand  extends CompositeCommand implements Command {
    ...
    public AlterContactCommand(PhoneBook phoneBook, int recordNumber) {
        ...
        super.addChild(new EditCommand(phoneBook, recordNumber));
        super.addChild(new RemoveCommand(phoneBook));
    }
